...
class AudioManagerScreen extends StatefulWidget {
  ...
  const AudioManagerScreen({super.key, required this.filePath});
  @override
  _AudioManagerScreenState createState() => _AudioManagerScreenState();
}
...
class _AudioManagerScreenState extends State<AudioManagerScreen> {
  ...
  Duration _position = Duration(minutes: 1);
  double _slider = 0.0;
